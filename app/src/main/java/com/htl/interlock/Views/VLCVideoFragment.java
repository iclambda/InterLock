...
public class VLCVideoFragment extends Fragment implements SurfaceHolder.Callback, IVideoPlayer {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_vlcvideo, container, false);
        mSurfaceView = (SurfaceView) root.findViewById(R.id.video);
    ...
    {
        try {
            mMediaPlayer = VLCInstance.getLibVlcInstance(getActivity());
        ...
        mMediaPlayer.restart(this.getActivity());

        //mMediaPlayer.setMediaList();
        //mMediaPlayer.getMediaList().add(new Media(mMediaPlayer,LibVLC.PathToURI("/sdcard/man.rmvb")), false);
